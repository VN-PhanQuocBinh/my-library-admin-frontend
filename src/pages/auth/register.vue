  ...
  <div class="flex flex-col items-center gap-2 w-full">
    ...
    >
      ...
      <FormField class="flex flex-col gap-1">
        ...
        <Message v-if="$form.fullname?.invalid" severity="error" size="fullname" variant="simple">
      ...
      <div class="flex flex-row gap-3">
        ...
        <!-- Role -->
        <FormField class="flex-1 flex flex-col gap-1">
          <label for="duty" class="text-gray-600">Vai trò</label>
          <Select
            name="duty"
            :options="[
      ...
      <Button type="submit" size="large" severity="success" label="Đăng ký" :loading="false" />

      <p class="text-gray-600 text-center">
        Bạn đã có tài khoản?
        <router-link to="/login" class="text-green-500 underline">Đăng nhập</router-link>
      </p>
    </Form>
  </div>
</template>
